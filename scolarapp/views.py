...
class UserViewSet(viewsets.ModelViewSet):
    ...
    def update_teacher(self, request, pk=None):
        ...
        if subject_id:
            ...
            teacher.subject = subject_instance  # Assigner l'instance du sujet
        else:
            teacher.subject = None  # Gérer le cas où aucun sujet n'est fourni
...
class SendSMSView(APIView):
    def post(self, request):
        ...
        try:
            send_sms(user=None, phone_number=phone_number, message=message)
